...
$token = 'https://graph.facebook.com/oauth/access_token?client_id=573341462823400&client_secret=a0bc94a2cb83a1fc1c195856e520481a&grant_type=client_credentials&redirect_uri=http%3a%2f%2f'.$url;//generate an access token using the app secret and app id
	$ch = curl_init(); 
...
$request = "https://graph.facebook.com/86348506359/albums?fields=photos&limit=".$limit."&".$output;//get a json feed of all the photos in a specific album (86348506359)
	$ch = curl_init(); 
