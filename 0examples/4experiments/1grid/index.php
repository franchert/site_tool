...
$p_content .= p_grid('horizontal',2,'horizontal 2');
$p_content .= p_grid('horizontal',3,'horizontal 3');
$p_content .= p_grid('horizontal right',3,'horizontal right 3');
$p_content .= p_grid('horizontal',4,'horizontal 4');
$p_content .= p_grid('vertical',2,'vertical 2');
$p_content .= p_grid('vertical',3,'vertical 3');
$p_content .= p_grid('vertical',4,'vertical 4');
