...
/*actual on-page content*/
	$l_nav_sidebar .= p_promo(['type'=>"button",'image_type'=>"image",'title'=>"Button Promo"]);
	$l_nav_sidebar .= p_promo(['type'=>"button",'image_type'=>"image",'extra_class'=>"light",'title'=>"Button Promo Light"]);
	$l_nav_sidebar .= p_promo(['type'=>"button",'image_type'=>"image",'extra_class'=>"dark",'title'=>"Button Promo Dark"]);
	...
	$l_content .= p_form();
	$l_promo_sidebar .= p_promo(['type'=>"panel",'image_type'=>"image"]);
