...
$p_promo_sidebar .= "<section><h2>Have Any Questions?</h2>".p_text_image_intro(
	"button light",
	"Chat Now",
	null,
	null,
...
$p_content_footer .="<section><div class='wrapper'><div class='column'>".p_matrix(
	...
	array(
		p_text_image_intro("generic","Visit The Campus",'Your first step is to submit an application for admission online. After that, requirements vary depending on whether you are a recent high school graduate, student transferring from another institution or returning adult.',NULL,'https://placehold.it/800x600.png','#','','',array(p_link('','#','Open Houses'),p_link('','#','Enhanced Visits'),p_link('','#','Information Sessions & Campus Tours'))),
		p_text_image_intro("generic","How to Apply",'Your first step is to submit an application for admission online. After that, requirements vary depending on whether you are a recent high school graduate',NULL,'https://placehold.it/800x600.png','#','','',array(p_link('','#','The Application Process'),p_link('','#','Apply Now'))),
		p_text_image_intro("generic","Financial Aid & Costs",'Your first step is to submit an application for admission online. After that, requirements vary depending on whether you are a recent high school graduate',NULL,'https://placehold.it/800x600.png',"#",'','',array(p_link('','#','Learn More'))),
	)
).'</div></div></section>';
...
$p_content_footer .="<section><div class='wrapper'><div class='column'>".p_matrix("ug-admissions",array(
	p_text_image_intro("overlay","Student Spotlight","Seema Bhat, MBA","","/.includes/images/seema-bhat.jpg","#",'','spotlight'),
	p_tabs("tab-1",$p_t_1,'active:0,','false'),
	p_text_image_intro("promo wrap","Download the Explore UNH App","Get to know the University of New Haven before you even set foot on campus! Start exploring now!",NULL,"https://placehold.it/50x100.png")
	)
).'</div></div></section>';
$p_content_footer .="<section><div class='wrapper'><div class='column'><h2>Awards & Recognitions</h2>".p_matrix("ug-awards",array(
	p_text_image_intro('genericv2','Military Friendly School','','','/.includes/images/military-friendly.png'),
	p_text_image_intro('genericv2','Colleges of Distinction</br>2014-2015','','','/.includes/images/colleges-distinction.png'),
	p_text_image_intro('genericv2','US News</br>Best Colleges','','','/.includes/images/us-news.png'),
	p_text_image_intro('genericv2','Military Times</br>Best For Vets 2014','','','/.includes/images/military-times.png'),
	p_text_image_intro('genericv2','The Princeton Review</br>Best Regional Colleges 2015','','','/.includes/images/princeton-review.png')
	)
).'</div></div></section>';
