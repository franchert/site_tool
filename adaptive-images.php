...
$resolutions   = array(1200, 1120, 720); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = ".includes/images/"; // where to store the generated re-sized images. Specify from your document root!
