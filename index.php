...
$p_one .="<blockquote>$ p_one .= p_link();</blockquote>";
...
$p_one .="<blockquote>&lt;a href='#'&gt;lorem ipsum&lt;/a&gt;</blockquote>";
...
$p_one .="<blockquote>$ p_one .= p_link('http://www.example.com','New Title','button');</blockquote>";
$p_one .="<p>Now we have a more specific example:</p>";
$p_one .="<blockquote>&lt;a class='button' href='http://www.example.com'&gt;New Title&lt;/a&gt;</blockquote>";
...
$p_one .="<blockquote>$ p_one .= p_slider_owl('example');</blockquote>";
$p_one .="<p>Our 'example' (added as the slider id) slider here uses multiple 'slide' components with a 'promo' component in each. This 'promo' is built up of a 'paragraph' component and a 'link' component (as well as some static content).</p>";
