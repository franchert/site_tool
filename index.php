...
$l_one_col .="<div style='width:300px;padding-right:20px;'>".p_promo("button","image","light","Examples Section",null,null,null,"/0examples")."</div>";
...
$l_one_col .="<div style='float:right;width:300px;padding-left:20px;'>".p_promo("button","image","light","the Utility Section",null,null,null,"/.util")."</div>";
